"use strict";
const DEBUG = false;
const BASE_URL = "https://www.clubpeugeot.es/";
const CACHED_ASSETS = ["https://www.clubpeugeot.es/offline/"];
const CACHE_NAME = 'invision-community-4b2831cbee1726388013';
const OFFLINE_URL = "https://www.clubpeugeot.es/offline/";
const NOTIFICATION_ICON = "https://www.clubpeugeot.es/uploads/monthly_2023_08/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Tienes una nueva notificación";
const DEFAULT_NOTIFICATION_BODY = "Debes visitar el sitio para leerla. Toque aquí para iniciar sesión.";
/**
 * Invision Community
