"use strict";
const DEBUG = false;
const BASE_URL = "https://atrl.net/";
const CACHED_ASSETS = ["https://atrl.net/offline/"];
const CACHE_NAME = 'invision-community-e85fda5e8a1731008673';
const OFFLINE_URL = "https://atrl.net/offline/";
