const CACHE_VERSION = '1.7.47.2';

const BASE_CACHE_FILES = [
    'https://dewabiz.com/wp-content/uploads/2021/02/icon-192x192-1.png',
'https://dewabiz.com/wp-content/uploads/2021/02/icon-512x512-1.png',
'https://dewabiz.com/wp-content/uploads/2021/02/icon-512x512-1.png',
...
const OFFLINE_PAGE = 'https://dewabiz.com/';
const NOT_FOUND_PAGE = 'https://dewabiz.com/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://dewabiz.com//wp-admin/');
//    },
];
