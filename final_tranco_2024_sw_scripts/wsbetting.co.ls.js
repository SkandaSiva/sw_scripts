/*
Lesotho Mobile Dec 2020
*/
var applicationServerKey ="BLsRtgIh0515VyDTf2tK1v_e45ZYZybsy6d01wxSZnVaz1kuRyulldDX_zmKFewF_AU5qf1nn8jN-KYSam7wNjE";
var url = "https://m.wsbetting.co.ls/";
var identifier="";
...
self.addEventListener("push", function(event) {
  ...
  var tag = data.tag || "Wsbetting";
  var title = data.title.replace(/&amp;/g,"&") || "Wsbetting";
  ...
  event.notification.close();
   ...
   if(event.action != "" && event.action!=null) { 
    ...
    clients.openWindow(url);
	   ...
	   {
	   clients.openWindow("https://m.wsbetting.co.ls/");
	   }
