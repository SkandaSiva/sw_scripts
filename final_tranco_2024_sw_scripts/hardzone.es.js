...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/hardzone.es\/app\/plugins\/pwa\/wp-includes\/js\/workbox-v7.0.0\/"} );
...
(() => {
	wp.serviceWorker.precaching.precache([{"url":"https:\/\/hardzone.es\/?wp_error_template=offline","revision":"0.8.1;gaz-v1=1.0.0;options=ffddab32d96563a259a6337d6b5c1ba7;nav=cf60ae4359c0aa6efb7552fbf3b204a6;deps=de920db40fcd39f24fd6e7fc60cd2b47;eb44de763f5c626c4c747e80e8514c90"},{"url":"https:\/\/hardzone.es\/?wp_error_template=500","revision":"0.8.1;gaz-v1=1.0.0;options=ffddab32d96563a259a6337d6b5c1ba7;nav=cf60ae4359c0aa6efb7552fbf3b204a6;deps=de920db40fcd39f24fd6e7fc60cd2b47;f84c0f5ea1f9635ad0b380c4c6c4e38e"}]);
...
(() => {
	...
	const errorMessages = {"clientOffline":"It seems you are offline. Please check your internet connection and try again.","serverOffline":"Parece que el servidor no funciona o tu conexi\u00f3n no funciona como se esperaba. Por favor, int\u00e9ntalo de nuevo m\u00e1s tarde.","error":"Something prevented the page from being rendered. Please try again.","submissionFailure":"Your submission failed. Please go back and try again."};
	const navigationRouteEntry = {"url":null,"revision":"0.8.1;gaz-v1=1.0.0;options=ffddab32d96563a259a6337d6b5c1ba7;nav=cf60ae4359c0aa6efb7552fbf3b204a6;deps=de920db40fcd39f24fd6e7fc60cd2b47"};
