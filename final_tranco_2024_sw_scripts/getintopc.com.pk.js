const CACHE_VERSION = '1.7.72';

const BASE_CACHE_FILES = [
    'https://getintopc.com.pk/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://getintopc.com.pk/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
'https://getintopc.com.pk/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://getintopc.com.pk/',
];
...
const OFFLINE_PAGE = 'https://getintopc.com.pk/';
const NOT_FOUND_PAGE = 'https://getintopc.com.pk/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://getintopc.com.pk//wp-admin/');
//    },
];
