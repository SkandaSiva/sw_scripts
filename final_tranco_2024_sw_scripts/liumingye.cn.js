...
// src/scripts/lang.ts
var SwLang = class {
  cacheName = `mk-cache-${"w-yVYEeaDJqjVZY6d0hynA"}`;
  ...
  async _fetch() {
    const localeUrl = `/assets/locales/${await this.lang}.${"w-yVYEeaDJqjVZY6d0hynA"}.json`;
