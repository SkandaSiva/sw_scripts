importScripts( 'https://hentaitk.net/wp-content/plugins/onesignal-free-web-push-notifications/sdk_files/OneSignalSDKWorker.js.php' );
'use strict';
...
const cacheName = 'hentaitk.net-superpwa-2.2.23.1';
const startPage = 'https://hentaitk.net';
const offlinePage = 'https://hentaitk.net';
