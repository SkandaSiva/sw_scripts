...
const cacheName = 'jerusalem-patriarchate.info-superpwa-2.2.28';
const startPage = 'https://jerusalem-patriarchate.info';
const offlinePage = 'https://jerusalem-patriarchate.info';
