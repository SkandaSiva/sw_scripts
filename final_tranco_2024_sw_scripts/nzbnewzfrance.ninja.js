"use strict";
const DEBUG = false;
const BASE_URL = "https://www.nzbnewzfrance.ninja/";
const CACHED_ASSETS = ["https://www.nzbnewzfrance.ninja/offline/"];
const CACHE_NAME = 'invision-community-0c4ef98cb81731263384';
const OFFLINE_URL = "https://www.nzbnewzfrance.ninja/offline/";
const NOTIFICATION_ICON = null;
const DEFAULT_NOTIFICATION_TITLE = "Vous avez une nouvelle notification";
const DEFAULT_NOTIFICATION_BODY = "Vous devrez visiter le site pour le lire. Appuyez ici pour vous connecter.";
/**
 * Invision Community
