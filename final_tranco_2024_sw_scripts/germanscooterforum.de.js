"use strict";
const DEBUG = false;
const BASE_URL = "https://www.germanscooterforum.de/";
const CACHED_ASSETS = ["https://www.germanscooterforum.de/offline/"];
const CACHE_NAME = 'invision-community-1bcedf0f5a1726862346';
const OFFLINE_URL = "https://www.germanscooterforum.de/offline/";
const NOTIFICATION_ICON = "https://cdn.germanscooterforum.de/static/icons-logos/monthly_2020_10/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Du hast eine neue Benachrichtigung";
const DEFAULT_NOTIFICATION_BODY = "Du musst die Seite besuchen, um es zu lesen. Tippe hier, um sich anzumelden.";
/**
 * Invision Community
