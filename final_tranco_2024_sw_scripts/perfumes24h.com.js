...
self.addEventListener('push', function(event) {
  ...
  const options = {
    ...
    icon: content.thumbnail,
      image: content.image,
    badge: 'https://perfumes24horas.com/static/template/perfumes24horas.com/img/noti.png',
    data: {url: content.url, webpush_id: content.webpush_id, customers_id: content.customers_id}
  };

  fetch("https://perfumes24horas.com/api/v1/webpush_actualizar.php?accion=recibido", {
    method: 'post',  
    headers: {  
...
self.addEventListener('notificationclick', function(event) {
  ...
  fetch("https://perfumes24horas.com/api/v1/webpush_actualizar.php?accion=leido", {
    method: 'post',  
    headers: {  
      "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"  
    },  
