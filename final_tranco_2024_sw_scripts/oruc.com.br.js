...
const cacheName = 'oruc.com.br-1.0.0';
const startPage = 'https://www.oruc.com.br';
const offlinePage = 'https://www.oruc.com.br/';
const filesToCache = [startPage, offlinePage];
const neverCacheUrls = [/\/checkout/,/\/loja-criada/];
