"use strict";
const DEBUG = false;
const BASE_URL = "https://www.photo.net/";
const CACHED_ASSETS = ["https://www.photo.net/offline/"];
const CACHE_NAME = 'invision-community-d815db93211728299384';
const OFFLINE_URL = "https://www.photo.net/offline/";
