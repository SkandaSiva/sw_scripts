"use strict";
const DEBUG = false;
const BASE_URL = "https://oldschool.co.nz/";
const CACHED_ASSETS = ["https://oldschool.co.nz/index.php?/offline/"];
const CACHE_NAME = 'invision-community-e2695397a41728188185';
const OFFLINE_URL = "https://oldschool.co.nz/index.php?/offline/";
const NOTIFICATION_ICON = "https://oldschool.co.nz/uploads/monthly_2020_08/android-chrome-192x192.png";
