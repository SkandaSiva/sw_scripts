    ...
    const staticFileCdn = "https://static-res-cdn.websites.hibu.com"
...
// version of site assets, should increase every publish
    pwaSettings.SITE_VERSION = toHash('1733172155000');

// version of runtime files, should increase on every deploy
    pwaSettings.RUNTIME_VERSION = toHash('2024-12-02T09_48_21');
