"use strict";
const DEBUG = false;
const BASE_URL = "https://baatplassen.no/i/";
const CACHED_ASSETS = ["https://baatplassen.no/i/offline/"];
const CACHE_NAME = 'invision-community-7ce4cfdf451724844575';
const OFFLINE_URL = "https://baatplassen.no/i/offline/";
const NOTIFICATION_ICON = "https://baatplassen.no/i/theme_resources/monthly_2021_03/android-chrome-192x192.png";
