...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/roughdraftatlanta.com\/wp-content\/plugins\/pwa\/wp-includes\/js\/workbox-v7.3.0\/"} );
...
(() => {
	wp.serviceWorker.precaching.precache([{"url":"https:\/\/roughdraftatlanta.com\/?wp_error_template=offline","revision":"0.8.2;newspack-theme=2.1.1;newspack-katharine=2.1.1;options=1a7ec5ada9efee81e8fcdb748788568b;nav=3fe148dc6d8b89e2183892fbdafb1975;deps=16e018ce05693aea76cab978d8661a29;0c2d584d75142f0aa2defbab82478d65"},{"url":"https:\/\/roughdraftatlanta.com\/?wp_error_template=500","revision":"0.8.2;newspack-theme=2.1.1;newspack-katharine=2.1.1;options=1a7ec5ada9efee81e8fcdb748788568b;nav=3fe148dc6d8b89e2183892fbdafb1975;deps=16e018ce05693aea76cab978d8661a29;2850a6265d25f3a1d90f8b58b11ca343"}]);
...
wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/roughdraftatlanta\\.com\\\/wp\\-includes\\\/.*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"core-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":14} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^(https\\:\\\/\\\/roughdraftatlanta\\.com\\\/wp\\-content\\\/themes\\\/newspack\\-theme\\\/|https\\:\\\/\\\/roughdraftatlanta\\.com\\\/wp\\-content\\\/themes\\\/newspack\\-katharine\\\/).*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"theme-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":34} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/roughdraftatlanta\\.com\\\/wp\\-content\\\/plugins\\\/.*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"plugin-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":44} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/roughdraftatlanta\\.com\\\/wp\\-content\\\/uploads\\\/.*\\.(jpg|jpeg|jpe|gif|png|bmp|tif|tiff|ico|heic|webp|avif)(\\?.*)?$" ), new wp.serviceWorker.strategies[ "StaleWhileRevalidate" ]( ( function() {const strategyArgs = {"cacheName":"uploaded-images"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxAgeSeconds":2592000,"maxEntries":100} )];return strategyArgs;} )() ) );