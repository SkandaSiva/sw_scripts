"use strict";
const DEBUG = false;
const BASE_URL = "https://ratsun.net/";
const CACHED_ASSETS = ["https://ratsun.net/offline/"];
const CACHE_NAME = 'invision-community-0b48e61f991721105426';
const OFFLINE_URL = "https://ratsun.net/offline/";
