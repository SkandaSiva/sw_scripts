"use strict";
const DEBUG = false;
const BASE_URL = "https://magelanci.com/";
const CACHED_ASSETS = ["https://magelanci.com/offline/"];
const CACHE_NAME = 'invision-community-c68f1902a31722534267';
const OFFLINE_URL = "https://magelanci.com/offline/";
const NOTIFICATION_ICON = null;
const DEFAULT_NOTIFICATION_TITLE = "Имаш ново известие";
const DEFAULT_NOTIFICATION_BODY = "Трябва да посетиш сайта за да я прочетеш. Кликни тук за да влезеш.";
/**
 * Invision Community
