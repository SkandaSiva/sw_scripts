"use strict";
const DEBUG = false;
const BASE_URL = "https://legalis.hr/";
const CACHED_ASSETS = ["https://legalis.hr/offline/"];
const CACHE_NAME = 'invision-community-d815db93211730740039';
const OFFLINE_URL = "https://legalis.hr/offline/";
