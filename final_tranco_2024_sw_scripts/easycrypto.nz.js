...
function oe(s) {
  ...
  return n.searchParams.set(ce, e), {
    cacheKey: n.href,
    url: a.href
  };
}
...
class ue {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), m = h ? await Z(
...
class de {
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: r } = oe(n), i = typeof n != "string" && n.revision ? "reload" : "default";
...
let T;
const V = () => (T || (T = new de()), T);
try {
  self["workbox:routing:7.0.0"] && _();
} catch {
}
const $ = "GET", L = (s) => s && typeof s == "object" ? s : { handle: s };
class b {
  /**
...
let y;
const ge = () => (y || (y = new pe(), y.addFetchListener(), y.addCacheListener()), y);
function g(s, e, t) {
  let n;
  if (typeof s == "string") {
...
const Q = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap();
function De(s) {
...
function ke(s) {
  return typeof s == "function" ? Te(s) : (s instanceof IDBTransaction && Le(s), Ce(s, xe()) ? new Proxy(s, I) : s);
}
function f(s) {
...
const Ne = ["get", "getKey", "getAll", "getAllKeys", "count"], Ie = ["put", "add", "delete", "clear"], M = /* @__PURE__ */ new Map();
function W(s, e) {
  ...
  if (
    ...
    !(t in (n ? IDBIndex : IDBObjectStore).prototype) || !(a || Ne.includes(t))
  )
    return;
...
const Ke = "workbox-expiration", R = "cache-entries", B = (s) => {
...
ie({ prefix: "easy-crypto" });
self.__precacheManifest = [].concat(self.__precacheManifest || []);
be(self.__precacheManifest, {});
self.addEventListener("message", (s) => {
  s.data === "skipWaiting" && self.skipWaiting();
});
g(
  /index.html$/,
  new x({
...
g(
  new RegExp("^https://static.easycrypto.com/.*?(?:png|gif|jpg|jpeg|svg)"),
  new x({
    cacheName: "static",
    plugins: [
      new E({
...
g(
  new RegExp("^https://s.easycrypto.nz/.*?(?:png|gif|jpg|jpeg|svg)"),
  new x({
    cacheName: "static",
    plugins: [
      new E({
