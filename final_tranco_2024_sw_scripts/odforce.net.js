"use strict";
const DEBUG = false;
const BASE_URL = "https://forums.odforce.net/";
const CACHED_ASSETS = ["https://forums.odforce.net/offline/"];
const CACHE_NAME = 'invision-community-e5fc2855201689474763';
const OFFLINE_URL = "https://forums.odforce.net/offline/";
