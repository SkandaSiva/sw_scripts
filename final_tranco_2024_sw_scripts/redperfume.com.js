...
self.addEventListener('push', function(event) {
    ...
    const options = {
        ...
        image: content.image,
        badge: 'https://redperfumes.com/static/template/redperfumes.com/img/noti.png',
        data: {url: content.url, webpush_id: content.webpush_id, customers_id: content.customers_id}
    };

    fetch("https://redperfumes.com/api/v1/webpush_actualizar.php?accion=recibido", {
        method: 'post',
        headers: {
...
self.addEventListener('notificationclick', function(event) {
    ...
    fetch("https://redperfumes.com/api/v1/webpush_actualizar.php?accion=leido", {
        method: 'post',
        headers: {
            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"
        },
