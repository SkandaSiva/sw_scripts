"use strict";
const DEBUG = false;
const BASE_URL = "https://www.politisti.ro/";
const CACHED_ASSETS = ["https://www.politisti.ro/offline/"];
const CACHE_NAME = 'invision-community-ba7eb5913c1723039142';
const OFFLINE_URL = "https://www.politisti.ro/offline/";
const NOTIFICATION_ICON = "https://www.politisti.ro/uploads/monthly_2023_04/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Aveţi o notificare nouă";
const DEFAULT_NOTIFICATION_BODY = "Trebuie să vizitaţi site-ul pentru a-l citi. Atingeţi aici pentru a vă conecta.";
/**
 * Invision Community
