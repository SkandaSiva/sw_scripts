...
const options = {
    firebaseConfig: {
        projectId: "push-f20d3",
        messagingSenderId: "1008514102757",
        appId: "1:1008514102757:web:7c6b3a4b5431c2f9b6ab0c",
        apiKey: "AIzaSyCrKcrxkwD1XxtzPH3qKJ_IuncGDEa_s1M",
    },
    domain: "www.red-redial.net",
    api_url: "https://push.readtrustedreviews.com/api/token",
...
self.addEventListener('notificationclick', (event) => {
    if (event.action == "") {
        ...
        clients.openWindow(event.notification.data.actions[event.action].click_action);
