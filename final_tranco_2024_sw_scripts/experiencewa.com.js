...
self.addEventListener('install', function(event) {
    event.waitUntil(caches.open('mmnindustrywot-core-v' + version)
    .then(function(cache) {
...
self.addEventListener('fetch', function(event) {
    ...
    // Open cache:
    caches.open('mmnindustrywot-dynamic-v' + version)
    .then(function(cache) {
...
self.addEventListener('activate', function(event) {
    ...
    .then(function(cacheNames) {
        cacheNames.filter(function(cacheName) {
            return cacheName === 'mmnindustrywot-dynamic-v' + version;
        })
