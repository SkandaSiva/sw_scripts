const CACHE_VERSION = '1.7.70.1';

const BASE_CACHE_FILES = [
    'https://federicovalli.it/wp-content/uploads/2020/11/pwa-valli-logo.png',
'https://federicovalli.it/wp-content/uploads/2017/11/Federico-Valli-Favicon-1.png',
'https://federicovalli.it/wp-content/uploads/2017/11/cropped-Federico-Valli-Favicon-1.png',

];

const OFFLINE_CACHE_FILES = [
     'https://federicovalli.it/contatti-ortopedico/',
];

const NOT_FOUND_CACHE_FILES = [
    'https://federicovalli.it/',
];

const OFFLINE_PAGE = 'https://federicovalli.it/contatti-ortopedico/';
const NOT_FOUND_PAGE = 'https://federicovalli.it/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://federicovalli.it//wp-admin/');
//    },
];
