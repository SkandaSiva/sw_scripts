...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/www.ashlandsource.com\/wp-content\/plugins\/pwa\/wp-includes\/js\/workbox-v7.3.0\/"} );
...
(() => {
	wp.serviceWorker.precaching.precache([{"url":"https:\/\/www.ashlandsource.com\/?wp_error_template=offline","revision":"0.8.2;newspack-theme=2.2.0;newspack-scott=2.2.0;options=2ca3993b33d3a26b135e2faa19938fca;nav=274198a27c34493f3b78c0d15df249b8;deps=1513911338bda09ad80aecd0307ac710;0c2d584d75142f0aa2defbab82478d65"},{"url":"https:\/\/www.ashlandsource.com\/?wp_error_template=500","revision":"0.8.2;newspack-theme=2.2.0;newspack-scott=2.2.0;options=2ca3993b33d3a26b135e2faa19938fca;nav=274198a27c34493f3b78c0d15df249b8;deps=1513911338bda09ad80aecd0307ac710;2850a6265d25f3a1d90f8b58b11ca343"}]);
...
wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/www\\.ashlandsource\\.com\\\/wp\\-includes\\\/.*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"core-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":14} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^(https\\:\\\/\\\/www\\.ashlandsource\\.com\\\/wp\\-content\\\/themes\\\/newspack\\-theme\\\/|https\\:\\\/\\\/www\\.ashlandsource\\.com\\\/wp\\-content\\\/themes\\\/newspack\\-scott\\\/).*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"theme-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":34} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/www\\.ashlandsource\\.com\\\/wp\\-content\\\/plugins\\\/.*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"plugin-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":44} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/newspack\\-ashlandsource\\.s3\\.amazonaws\\.com\\\/wp\\-content\\\/uploads\\\/.*\\.(jpg|jpeg|jpe|gif|png|bmp|tif|tiff|ico|heic|webp|avif)(\\?.*)?$" ), new wp.serviceWorker.strategies[ "StaleWhileRevalidate" ]( ( function() {const strategyArgs = {"cacheName":"uploaded-images"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxAgeSeconds":2592000,"maxEntries":100} )];return strategyArgs;} )() ) );