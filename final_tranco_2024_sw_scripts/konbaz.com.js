"use strict";
const DEBUG = false;
const BASE_URL = "https://konbaz.com/";
const CACHED_ASSETS = ["https://konbaz.com/offline/"];
const CACHE_NAME = 'invision-community-4e52a1ea3c1699071961';
const OFFLINE_URL = "https://konbaz.com/offline/";
const NOTIFICATION_ICON = null;
const DEFAULT_NOTIFICATION_TITLE = "شما اعلامیه جدیدی دارید";
const DEFAULT_NOTIFICATION_BODY = "برای خواندن نیاز است تا از سایت بازدید نمایید. اینجا را برای ورود بزنید.";
/**
 * Invision Community
