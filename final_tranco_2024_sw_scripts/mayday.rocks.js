const CACHE_VERSION = '1.7.37.3';

const BASE_CACHE_FILES = [
    'https://mayday.rocks/wp-content/uploads/2020/01/icon192x192.png',
'https://mayday.rocks/wp-content/uploads/2020/01/icon5612x512.jpg',
...
const OFFLINE_PAGE = 'https://mayday.rocks/';
const NOT_FOUND_PAGE = 'https://mayday.rocks/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://mayday.rocks//wp-admin/');
//    },
];
