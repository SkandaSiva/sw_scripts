"use strict";
const DEBUG = false;
const BASE_URL = "https://lplive.net/";
const CACHED_ASSETS = ["https://lplive.net/offline/"];
const CACHE_NAME = 'invision-community-707bf04de31726460771';
const OFFLINE_URL = "https://lplive.net/offline/";
