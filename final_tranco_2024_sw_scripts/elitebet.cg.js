var applicationServerKey ="BG7zeuOPnvlsj5pL4pEoROtIMwHptd-uAR0xavvlFohGQcOU-u-WHTICqPuLIbtA_gKLn2whwj9n0A_VghbrPBQ";
var url = "https://www.elitebet.cg/";
var identifier="";
...
self.addEventListener("push", function(event) {
  ...
  var tag = data.tag || "Elitebet";
  var title = data.title.replace(/&amp;/g,"&") || "Elitebet";
  ...
  event.notification.close();
   ...
   if(event.action != "" && event.action!=null) { 
    ...
    clients.openWindow(url);
	   ...
	   {
	   clients.openWindow("https://www.elitebet.cg/");
	   }
