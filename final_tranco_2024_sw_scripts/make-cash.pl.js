"use strict";
const DEBUG = false;
const BASE_URL = "https://make-cash.pl/";
const CACHED_ASSETS = ["https://make-cash.pl/offline/"];
const CACHE_NAME = 'invision-community-98a612c4731729863677';
const OFFLINE_URL = "https://make-cash.pl/offline/";
const NOTIFICATION_ICON = "https://make-cash.pl/uploads/monthly_2021_03/android-chrome-192x192.png";
