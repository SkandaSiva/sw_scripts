  ...
  initialize: function (options) {
    ...
    self.addEventListener('fetch', function (event) {
      ...
      let isTrackingRequest =
        event.request.url.includes('/matomo.php') || event.request.url.includes('/piwik.php')
      let isTrackerRequest =
        event.request.url.endsWith('/matomo.js') || event.request.url.endsWith('/piwik.js')
