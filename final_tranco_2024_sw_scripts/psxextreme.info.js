"use strict";
const DEBUG = false;
const BASE_URL = "https://www.psxextreme.info/";
const CACHED_ASSETS = ["https://www.psxextreme.info/offline/"];
const CACHE_NAME = 'invision-community-f4e16bfbcf1723031196';
const OFFLINE_URL = "https://www.psxextreme.info/offline/";
const NOTIFICATION_ICON = "https://www.psxextreme.info/uploads/monthly_2020_09/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Masz nowe powiadomienie";
const DEFAULT_NOTIFICATION_BODY = "Aby ją przeczytać, musisz odwiedzić tę witrynę. Kliknij tutaj, aby się zalogować.";
/**
 * Invision Community
