const CACHE = 'wholegrain2020-1.1.2';
...
self.addEventListener('fetch', function(evt) {
    ...
    // Ignore requests for other WordPress related URLs
    if (request.url.includes('/wp-includes')) {
        return;
    }

    // Ignore requests for REST API related URLs
    ...
    if (request.url.search('newrelic.com') != -1) {
        return;
    }
