...
;// CONCATENATED MODULE: ./sw/modules/named-cache-storage.ts
...
;// CONCATENATED MODULE: ./sw/modules/adapter.ts
...
;// CONCATENATED MODULE: ./sw/modules/database.ts
class NotFound {
...
;// CONCATENATED MODULE: ./sw/modules/db-cache.ts
...
;// CONCATENATED MODULE: ./sw/modules/api.ts
...
;// CONCATENATED MODULE: ./sw/modules/error.ts
...
;// CONCATENATED MODULE: ./sw/modules/sha1.ts
function sha1(str) {
    const utf8 = str;
...
;// CONCATENATED MODULE: ./sw/modules/assets.ts
...
;// CONCATENATED MODULE: ./sw/modules/data.ts
class LruList {
    constructor(state) {
        if (state === undefined) {
            state = {
...
;// CONCATENATED MODULE: ./sw/modules/app-version.ts
...
;// CONCATENATED MODULE: ./sw/modules/debug.ts
...
;// CONCATENATED MODULE: ./sw/modules/idle.ts
class IdleScheduler {
...
;// CONCATENATED MODULE: ./sw/modules/manifest.ts

function hashManifest(manifest) {
    return sha1(JSON.stringify(manifest));
}

;// CONCATENATED MODULE: ./sw/modules/msg.ts
...
;// CONCATENATED MODULE: ./sw/modules/driver.ts
...
class Driver {
    ...
    async handleClick(notification, action) {
        ...
        if (matchingClient) {
            if (url.includes("/newui/")) {
                matchingClient = await matchingClient.navigate(url);
            }
            await (matchingClient === null || matchingClient === void 0 ? void 0 : matchingClient.focus());
        }
        else {
            await this.scope.clients.openWindow(url);
        }
        await this.broadcast({
