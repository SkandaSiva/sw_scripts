...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/www.edivaldobrito.com.br\/wp-content\/plugins\/pwa\/wp-includes\/js\/workbox-v7.0.0\/"} );
	...
	self.addEventListener('install', (event) => {
		event.waitUntil(
			caches
				...
				.then((cache) => cache.addAll(["https:\/\/cdn.ampproject.org\/v0.js","https:\/\/cdn.ampproject.org\/v0\/amp-bind-0.1.js","https:\/\/cdn.ampproject.org\/v0\/amp-form-0.1.js","https:\/\/cdn.ampproject.org\/v0\/amp-install-serviceworker-0.1.js"]))
		);
	});
}
...
(() => {
	const errorMessages = {"clientOffline":"Parece que voc\u00ea est\u00e1 off-line. Verifique sua conex\u00e3o a internet e tente novamente.","serverOffline":"O servidor parece estar inativo ou sua conex\u00e3o n\u00e3o funciona como esperado. Por favor, tente novamente mais tarde.","error":"Algo impediu que a p\u00e1gina fosse renderizada. Tente novamente.","submissionFailure":"Seu envio falhou. Volte e tente novamente."};
...
(() => {
	...
	const errorMessages = {"clientOffline":"Parece que voc\u00ea est\u00e1 off-line. Verifique sua conex\u00e3o a internet e tente novamente.","serverOffline":"O servidor parece estar inativo ou sua conex\u00e3o n\u00e3o funciona como esperado. Por favor, tente novamente mais tarde.","error":"Algo impediu que a p\u00e1gina fosse renderizada. Tente novamente.","submissionFailure":"Seu envio falhou. Volte e tente novamente."};
	const navigationRouteEntry = {"url":null,"revision":"0.8.1;generatepress=3.5.1;options=29389d8425d26bc3334e55cc9b97598d;nav=6f5e1d7091ec2eb40b39fcbf115aa52b;deps=7f6c6e1500b92f0bc958a53c0e5d6269"};
