"use strict";
const DEBUG = false;
const BASE_URL = "https://www.insomnia.gr/";
const CACHED_ASSETS = ["https://www.insomnia.gr/offline/"];
const CACHE_NAME = 'invision-community-55905d84981730924601';
const OFFLINE_URL = "https://www.insomnia.gr/offline/";
const NOTIFICATION_ICON = "//cdn.insomnia.gr/uploads/monthly_2022_05/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Έχετε μια νέα ειδοποίηση";
const DEFAULT_NOTIFICATION_BODY = "Θα πρέπει να επισκεφθείτε το site για να το διαβάσετε. Κάντε tap εδώ για να συνδεθείτε.";
/**
 * Invision Community
