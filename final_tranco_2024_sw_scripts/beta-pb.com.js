"use strict";
const DEBUG = false;
const BASE_URL = "https://beta-pb.com/";
const CACHED_ASSETS = ["https://beta-pb.com/offline/"];
const CACHE_NAME = 'invision-community-88c0033de71711716244';
const OFFLINE_URL = "https://beta-pb.com/offline/";
const NOTIFICATION_ICON = null;
const DEFAULT_NOTIFICATION_TITLE = "คุณมีการแจ้งเตือนใหม่";
const DEFAULT_NOTIFICATION_BODY = "คุณจะต้องไปที่ไซต์เพื่ออ่าน แตะที่นี่เพื่อเข้าสู่ระบบ";
/**
 * Invision Community
