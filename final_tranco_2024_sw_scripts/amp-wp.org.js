...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/amp-wp.org\/wp-content\/plugins\/pwa\/wp-includes\/js\/workbox-v7.0.0\/"} );
...
(() => {
	wp.serviceWorker.precaching.precache([{"url":"https:\/\/amp-wp.org\/?wp_error_template=offline","revision":"0.8.1;amp-wp-org-theme=1.0.0;options=080c2f88658db3139a159175cf367e68;nav=c77675e2c38e42ea6f6fe00e6bd31bcd;deps=04c8ba4398131a8242f9c3af185bb241;0971ed8614bf6e9b3553d57a24fc363b"},{"url":"https:\/\/amp-wp.org\/?wp_error_template=500","revision":"0.8.1;amp-wp-org-theme=1.0.0;options=080c2f88658db3139a159175cf367e68;nav=c77675e2c38e42ea6f6fe00e6bd31bcd;deps=04c8ba4398131a8242f9c3af185bb241;2465204027752595b19b53fe531c938e"}]);
	...
	self.addEventListener('install', (event) => {
		event.waitUntil(
			caches
				...
				.then((cache) => cache.addAll(["https:\/\/cdn.ampproject.org\/v0.js","https:\/\/cdn.ampproject.org\/v0\/amp-bind-0.1.js","https:\/\/cdn.ampproject.org\/v0\/amp-form-0.1.js","https:\/\/cdn.ampproject.org\/v0\/amp-install-serviceworker-0.1.js","https:\/\/cdn.ampproject.org\/v0\/amp-analytics-0.1.js"]))
		);
	});
}
		...
		return fetch(event.request)
					...
					return caches
						.match(
							wp.serviceWorker.precaching.getCacheKeyForURL(
								"https:\/\/amp-wp.org\/?wp_error_template=500"
							)
						)
			...
			.catch(() => {
				...
				return caches
					.match(
						wp.serviceWorker.precaching.getCacheKeyForURL(
							"https:\/\/amp-wp.org\/?wp_error_template=offline"
						)
					)
...
(() => {
	...
	const errorMessages = {"clientOffline":"It seems you are offline. Please check your internet connection and try again.","serverOffline":"The server appears to be down, or your connection isn't working as expected. Please try again later.","error":"Something prevented the page from being rendered. Please try again.","submissionFailure":"Your submission failed. Please go back and try again."};
	const navigationRouteEntry = {"url":null,"revision":"0.8.1;amp-wp-org-theme=1.0.0;options=080c2f88658db3139a159175cf367e68;nav=c77675e2c38e42ea6f6fe00e6bd31bcd;deps=04c8ba4398131a8242f9c3af185bb241"};
