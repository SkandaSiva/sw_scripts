    ...
    const staticFileCdn = "https://static-cdn.website-editor.net"
...
// version of site assets, should increase every publish
    pwaSettings.SITE_VERSION = toHash('1705785954000');

// version of runtime files, should increase on every deploy
    pwaSettings.RUNTIME_VERSION = toHash('2024-11-24T07_48_31');
