"use strict";
const DEBUG = false;
const BASE_URL = "https://forums.minecraftforge.net/";
const CACHED_ASSETS = ["https://forums.minecraftforge.net/offline/"];
const CACHE_NAME = 'invision-community-7cebd3f0171723060477';
const OFFLINE_URL = "https://forums.minecraftforge.net/offline/";
