"use strict";
const DEBUG = false;
const BASE_URL = "https://vice-online.com/";
const CACHED_ASSETS = ["https://vice-online.com/offline/"];
const CACHE_NAME = 'invision-community-0687a710351730734341';
const OFFLINE_URL = "https://vice-online.com/offline/";
const NOTIFICATION_ICON = "https://vice-online.com/uploads/monthly_2024_10/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Yeni bir bildirim aldınız!";
const DEFAULT_NOTIFICATION_BODY = "Okumak için siteyi ziyaret etmeniz gerekmektedir. Giriş yapmak için buraya dokunun.";
/**
 * Invision Community
