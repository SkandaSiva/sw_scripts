...
// who blatantly stole it from Jeremy
// Keith at: https://adactio.com/serviceworker.js
//---------------------------
...
var updateStaticCache = function() {
  return caches.open(version + staticCacheName)
    .then(function(cache) {
      ...
      cache.addAll([
        '/site-assets/lebon-ad/images/offline-kid.png',
        '/site-assets/lebon-ad/images/sprite.symbol.svg',
        '/site-assets/lebon-ad/images/lb-logo_color.svg',
        '/site-assets/lebon-ad/images/lb-logo_white.svg'
      ]);
      // These items must be cached for the Service Worker to complete installation
      return cache.addAll([
        '/site-assets/lebon-ad/css/main.min.css',
        '/site-assets/lebon-ad/js/main.min.js',
        '/site-assets/lebon-ad/js/lbFontawesome.min.js',
        '/offline',
        '/'
      ]);
    });
