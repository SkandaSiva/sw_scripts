...
var url = "https://m.castlebetlite.com/";
var identifier="";
...
self.addEventListener("push", function(event) {
  ...
  var message = data.body.replace(/&amp;/g,"&").replace(/&lt;/g, "<").replace(/&gt;/g, ">") || "Mulibwanji , happy betting";
  ...
  event.notification.close();
   ...
   if(event.action != "" && event.action!=null) { 
    ...
    clients.openWindow(url);
	   ...
	   {
	   clients.openWindow("https://m.castlebetlite.com/");
	   }
