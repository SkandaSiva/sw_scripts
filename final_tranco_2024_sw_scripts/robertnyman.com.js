...
// This code inspired by https://gist.github.com/adactio/fbaa3a5952774553f5e7
        ...
        return caches.open(version + staticCacheName)
            .then(function (cache) {
                return cache.addAll([
                    ...
                    '/code-libraries/',
                    '/feeds/',
                    '/wp-content/themes/2014/images/logo/barcelona.jpg',
                    '/wp-content/themes/2014/offline.html'
                ]);
            });
    };
                ...
                fetch(request)
                    ...
                    .catch(function () {
                        return caches.match(request)
                            .then(function (response) {
                                return response || caches.match('/wp-content/themes/2014/offline.html');
                            })
                    })
            );
            return;
