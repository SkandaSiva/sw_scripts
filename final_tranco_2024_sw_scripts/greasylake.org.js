"use strict";
const DEBUG = false;
const BASE_URL = "https://the-circuit.greasylake.org/";
const CACHED_ASSETS = ["https://the-circuit.greasylake.org/index.php?/offline/"];
const CACHE_NAME = 'invision-community-1ae69f6cf41731440709';
const OFFLINE_URL = "https://the-circuit.greasylake.org/index.php?/offline/";
