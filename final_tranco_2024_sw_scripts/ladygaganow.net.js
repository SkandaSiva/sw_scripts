"use strict";
const DEBUG = false;
const BASE_URL = "https://ladygaganow.net/";
const CACHED_ASSETS = ["https://ladygaganow.net/offline/"];
const CACHE_NAME = 'invision-community-52b353fe3d1721944073';
const OFFLINE_URL = "https://ladygaganow.net/offline/";
const NOTIFICATION_ICON = "https://ladygaganow.net/uploads/monthly_2021_01/android-chrome-192x192.png";
