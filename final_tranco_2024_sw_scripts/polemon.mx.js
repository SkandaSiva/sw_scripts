importScripts( 'https://polemon.mx/wp-content/plugins/onesignal-free-web-push-notifications/sdk_files/OneSignalSDKWorker.js.php' );
'use strict';
...
const cacheName = 'http://polemon.mx-superpwa-2.2.31';
const startPage = 'https://polemon.mx';
const offlinePage = 'https://polemon.mx';
