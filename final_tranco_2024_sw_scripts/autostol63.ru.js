var busApp = {
	'status':false,
	'setting':{
		upload:{"server":"https://autostol63.ru/","version":"1.0.13.2","api":"module/bus_app","lang":1,"offline_link":"/","offline_links":[],"cache_status":true,"cache_resources":[],"cache_resources_exception":"https://vk.com,https://www.instagram.com/alettools/,https://code-ya.jivosite.com,https://code.jivosite.com,https://node-ya6.jivosite.com,https://files.jivosite.com,https://www.gstatic.com,https://www.googletagmanager.com,https://www.google-analytics.com,https://fcmregistrations.googleapis.com,https://www.google.com,https://mc.yandex.ru,https://api-maps.yandex.ru,https://connect.facebook.net,https://schema.org,/index.php?route=product/search","cache_max_ages":604800,"cache_token":1670743304,"push_status":true,"push_service":1,"sync_status":false,"debug":false},
	...
	'browser':function() {
		...
		if (browsers && browsers[1] == 'chrome' && browsers[2] >= '40.0') {
			browsers2 = userAgent.match(/(brave|vivaldi|edge|msie|opera|yabrowser|huaweibrowser|miuibrowser)\/(\d+\.)/);
			if (browsers2) {
				browsers = browsers2;
			}
		}
...
//aHR0cHM6Ly9kZXYudG8vbmljb21hcnRpbi9zaGFyZS10YXJnZXQtYXBpLTUyNjM=
//aHR0cHM6Ly9ibG9nLmZvcm1wbC51cy9ob3ctdG8taGFuZGxlLXBvc3QtcHV0LXJlcXVlc3RzLWluLW9mZmxpbmUtYXBwbGljYXRpb25zLXVzaW5nLXNlcnZpY2Utd29ya2Vycy1pbmRleGVkYi1hbmQtZGE3ZDA3OThhOWFi
