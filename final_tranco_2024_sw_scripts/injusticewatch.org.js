...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/www.injusticewatch.org\/wp-content\/plugins\/pwa\/wp-includes\/js\/workbox-v7.3.0\/"} );
...
(() => {
	wp.serviceWorker.precaching.precache([{"url":"https:\/\/www.injusticewatch.org\/?wp_error_template=offline","revision":"0.8.2;newspack-theme=2.3.0;newspack-scott=2.3.0;options=77ef5ce3ac0a3ac1b2c93d12d8480293;nav=96db220d10e8423d4c08d5f596053f45;deps=d6c57e6dce8dedc874267cc2623c92f1;0c2d584d75142f0aa2defbab82478d65"},{"url":"https:\/\/www.injusticewatch.org\/?wp_error_template=500","revision":"0.8.2;newspack-theme=2.3.0;newspack-scott=2.3.0;options=77ef5ce3ac0a3ac1b2c93d12d8480293;nav=96db220d10e8423d4c08d5f596053f45;deps=d6c57e6dce8dedc874267cc2623c92f1;2850a6265d25f3a1d90f8b58b11ca343"}]);
...
wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/www\\.injusticewatch\\.org\\\/wp\\-includes\\\/.*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"core-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":14} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^(https\\:\\\/\\\/www\\.injusticewatch\\.org\\\/wp\\-content\\\/themes\\\/newspack\\-theme\\\/|https\\:\\\/\\\/www\\.injusticewatch\\.org\\\/wp\\-content\\\/themes\\\/newspack\\-scott\\\/).*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"theme-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":34} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/www\\.injusticewatch\\.org\\\/wp\\-content\\\/plugins\\\/.*" ), new wp.serviceWorker.strategies[ "NetworkFirst" ]( ( function() {const strategyArgs = {"cacheName":"plugin-assets"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxEntries":44} )];return strategyArgs;} )() ) );wp.serviceWorker.routing.registerRoute( new RegExp( "^https\\:\\\/\\\/www\\.injusticewatch\\.org\\\/wp\\-content\\\/uploads\\\/.*\\.(jpg|jpeg|jpe|gif|png|bmp|tif|tiff|ico|heic|heif|webp|avif)(\\?.*)?$" ), new wp.serviceWorker.strategies[ "StaleWhileRevalidate" ]( ( function() {const strategyArgs = {"cacheName":"uploaded-images"};if ( strategyArgs.cacheName && wp.serviceWorker.core.cacheNames.prefix ) { strategyArgs.cacheName = `${wp.serviceWorker.core.cacheNames.prefix}-${strategyArgs.cacheName}`; }strategyArgs.plugins = [new wp.serviceWorker[ "expiration" ][ "ExpirationPlugin" ]( {"maxAgeSeconds":2592000,"maxEntries":100} )];return strategyArgs;} )() ) );