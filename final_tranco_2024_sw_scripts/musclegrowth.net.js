"use strict";
const DEBUG = false;
const BASE_URL = "https://musclegrowth.net/";
const CACHED_ASSETS = ["https://musclegrowth.net/offline/"];
const CACHE_NAME = 'invision-community-8e5dc71f011730149381';
const OFFLINE_URL = "https://musclegrowth.net/offline/";
const NOTIFICATION_ICON = "//mg-static.net/monthly_2021_07/android-chrome-192x192.png";
