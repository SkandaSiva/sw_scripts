"use strict";
const DEBUG = false;
const BASE_URL = "https://lanos.com.ua/";
const CACHED_ASSETS = ["https://lanos.com.ua/offline/"];
const CACHE_NAME = 'invision-community-4e52a1ea3c1730466197';
const OFFLINE_URL = "https://lanos.com.ua/offline/";
const NOTIFICATION_ICON = "https://lanos.com.ua/uploads/monthly_2022_08/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "У вас є нове повідомлення";
const DEFAULT_NOTIFICATION_BODY = "Вам потрібно буде відвідати веб-сайт, щоб прочитати його. Натисніть тут, щоб увійти.";
/**
 * Invision Community
