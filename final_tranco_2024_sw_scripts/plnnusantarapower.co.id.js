...
const cacheName = 'http://www.plnnusantarapower.co.id-superpwa-2.2.32';
const startPage = 'https://www.plnnusantarapower.co.id';
const offlinePage = 'https://www.plnnusantarapower.co.id';
