"use strict";
const DEBUG = false;
const BASE_URL = "https://madonna-infinity.net/";
const CACHED_ASSETS = ["https://madonna-infinity.net/offline/"];
const CACHE_NAME = 'invision-community-d815db93211729198683';
const OFFLINE_URL = "https://madonna-infinity.net/offline/";
const NOTIFICATION_ICON = "//content.invisioncic.com/t331785/monthly_2021_02/android-chrome-192x192.png";
