"use strict";
const DEBUG = false;
const BASE_URL = "https://homemasters.ru/";
const CACHED_ASSETS = ["https://homemasters.ru/offline/"];
const CACHE_NAME = 'invision-community-1285164a231732146283';
const OFFLINE_URL = "https://homemasters.ru/offline/";
const NOTIFICATION_ICON = "https://homemasters.ru/theme_resources/monthly_2024_11/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "У вас есть новое уведомление";
const DEFAULT_NOTIFICATION_BODY = "Вам нужно будет посетить сайт, чтобы прочитать его. Нажмите здесь, чтобы войти.";
/**
 * Invision Community
