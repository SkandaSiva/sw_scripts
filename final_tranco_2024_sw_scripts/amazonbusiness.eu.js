...
<div class="a-container a-padding-double-large" style="min-width:350px;padding:44px 0 !important">
    ...
    <div class="a-row a-spacing-double-large" style="width: 350px; margin: 0 auto">
                ...
                <div class="a-box a-color-offset-background">
                    <div class="a-box-inner a-padding-extra-large">
                        ...
                        <form method="get" action="/errors/validateCaptcha" name="">
                            <input type=hidden name="amzn" value="SPxJEi3vx0tqrX0953u5Wg==" /><input type=hidden name="amzn-r" value="&#047;service&#045;worker.js" />
                                ...
                                <div class="a-box">
                                    <div class="a-box-inner">
                                        ...
                                        <div class="a-row a-text-center">
                                            <img src="https://images-na.ssl-images-amazon.com/captcha/usvmgloq/Captcha_cppfdiejwd.jpg">
                                        </div>
        ...
        <div class="a-text-center a-size-mini a-color-secondary">
          ...
          <script>
           if (true === true) {
             document.write('<img src="https://fls-eu.amaz'+'on.co.uk/'+'1/oc-csi/1/OP/requestId=Q4K9MYG82SVGG6C8DJ7W&js=1" />');
           };
          </script>
          <noscript>
            <img src="https://fls-eu.amazon.co.uk/1/oc-csi/1/OP/requestId=Q4K9MYG82SVGG6C8DJ7W&js=0" />
          </noscript>
        </div>
    </div>
    <script>
