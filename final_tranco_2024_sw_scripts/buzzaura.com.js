...
self.addEventListener('push', function(event) {
  ...
  let _badge = _data.badge ? ('https://cdn.buzzaura.com/Images/badge/' + _data.badge) : '';
    ...
    actions: [
      {
        action: 'open-action',
        title: _action,
        icon: 'https://cdn.buzzaura.com/Images/action_icon/a.png'
      },
    ],
    vibrate:[300,100,400]
  };
...
self.addEventListener('notificationclick', function(event) {
  ...
  if(event.notification.data) { //seems that background notification shown by system sends data this way
    ...
    redirectUrl = 'https://www.buzzaura.com/';
  }
