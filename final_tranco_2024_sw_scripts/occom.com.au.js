...
workbox.setConfig( {
    "debug": false,
    "modulePathPrefix": "https://occom.com.au/wp-content/plugins/pwa/wp-includes/js/workbox-v5.1.3/"
} );
...
(() => {
    ...
    {
        "url": "https://occom.com.au/?wp_error_template=offline",
        "revision": "0.5.0;jelyco=1.0.0;jelyco-child=;options=87689f666af19ef2af5352e23713515e;nav=8a0be2d3753bdc93706dd20a4148ff69;deps=69abb104429b584a7cf842f5f1490204;4a8515459b5828c17615d803760151d6"
    },
    {
        "url": "https://occom.com.au/?wp_error_template=500",
        "revision": "0.5.0;jelyco=1.0.0;jelyco-child=;options=87689f666af19ef2af5352e23713515e;nav=8a0be2d3753bdc93706dd20a4148ff69;deps=69abb104429b584a7cf842f5f1490204;bdda2e4fc81cafbb890f449de9d2cff4"
    }
]);
		...
		return fetch(event.request)
					...
					return caches
						.match(
							wp.serviceWorker.precaching.getCacheKeyForURL(
								"https://occom.com.au/?wp_error_template=500"
							)
						)
			...
			.catch(() => {
				...
				return caches
					.match(
						wp.serviceWorker.precaching.getCacheKeyForURL(
							"https://occom.com.au/?wp_error_template=offline"
						)
					)
...
(() => {
    ...
    "url": null,
    "revision": "0.5.0;jelyco=1.0.0;jelyco-child=;options=87689f666af19ef2af5352e23713515e;nav=8a0be2d3753bdc93706dd20a4148ff69;deps=69abb104429b584a7cf842f5f1490204"
};
