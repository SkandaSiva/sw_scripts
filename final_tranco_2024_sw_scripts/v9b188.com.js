...
}, P = (s) => [d.prefix, s, d.suffix].filter((e) => e && e.length > 0).join("-"), Y = (s) => {
...
async function ie(s, e) {
  ...
  }, r = e ? e(a) : a, i = te() ? n.body : await n.blob();
...
function he(s) {
  ...
  return n.searchParams.set(oe, e), {
    cacheKey: n.href,
    url: a.href
  };
}
...
class de {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), m = h ? await ee(
...
class fe {
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: r } = he(n), i = typeof n != "string" && n.revision ? "reload" : "default";
...
const z = "GET", L = (s) => s && typeof s == "object" ? s : { handle: s };
class b {
  /**
...
let y;
const me = () => (y || (y = new ge(), y.addFetchListener(), y.addCacheListener()), y);
function g(s, e, t) {
  let n;
  if (typeof s == "string") {
...
function* ye(s, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: t = "index.html", cleanURLs: n = !0, urlManipulation: a } = {}) {
  const r = new URL(s, location.href);
  r.hash = "", yield r.href;
  const i = we(r, e);
...
function Re(s) {
  const e = $(), t = new _e(e, s);
  g(t);
}
const be = "-precache-", Ce = async (s, e = be) => {
...
const G = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap();
function Te(s) {
...
function Ne(s) {
  return s === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return s.apply(T(this), e), f(G.get(this));
  } : function(...e) {
    return f(s.apply(T(this), e));
  };
}
function Me(s) {
  return typeof s == "function" ? Ne(s) : (s instanceof IDBTransaction && Ae(s), Pe(s, ve()) ? new Proxy(s, N) : s);
}
function f(s) {
...
const Oe = ["get", "getKey", "getAll", "getAllKeys", "count"], We = ["put", "add", "delete", "clear"], A = /* @__PURE__ */ new Map();
function F(s, e) {
...
const Be = "workbox-expiration", R = "cache-entries", H = (s) => {
...
class je {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Ke(Be, 1, {
...
self.skipWaiting();
ce();
De([{"revision":"c9184e57f50700d62b266ac4028e525b","url":"_nuxt/builds/latest.json"},{"revision":null,"url":"_nuxt/builds/meta/a22caa22-7a25-4c12-8662-b7c8e2bd616a.json"}]);
xe();
g(
  ({ url: s }) => new RegExp("https://v9bet-cdn.v9sb.com/*").test(s),
  new U({
    cacheName: "cdn-static-files",
    plugins: [
      new E({
        statuses: [0, 200]
      }),
...
g(
  ({ url: s }) => new RegExp("https://ibr-doc-cdn.docbv9a1.com/*").test(s),
  new U({
    cacheName: "pcdn-static-files",
    plugins: [
      new E({
        statuses: [0, 200]
      }),
...
g(
  ({ url: s }) => new RegExp("https://app-test.insvr.com/service/*").test(s),
  new U({
    cacheName: "third-part-api",
    plugins: [
      new E({
        statuses: [0, 200]
      }),
...
const qe = new RegExp("/api/v1/(announcement|promotion)/fetch[a-zA-Z]+", "i");
g(
  ({ url: s }) => qe.test(s),
  new U({
    cacheName: "api-cache-5mins",
    plugins: [
      new E({
        statuses: [0, 200]
      }),
...
const Ve = new RegExp("/api/v1/(common)/fetch[a-zA-Z]+", "i");
g(
  ({ url: s }) => Ve.test(s),
  new Ue({
    cacheName: "api-cache-1min",
    plugins: [
      new E({
        statuses: [0, 200]
      }),
...
self.addEventListener("activate", (s) => {
  s.preventDefault();
  let e = s, t = document.getElementById("install-button");
  t.style.display = "block", t.addEventListener("click", (n) => {
    t.style.display = "none", e.prompt(), e.userChoice.then((a) => {
      a.outcome === "accepted" ? (console.log("User accepted the A2HS prompt"), gtag("event", "PWA Install", {
        event_category: "PWA",
        event_label: "Install"
      })) : console.log("User dismissed the A2HS prompt"), e = null;
    });
  });
});
