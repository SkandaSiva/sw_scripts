const CACHE_VERSION = '2.0.8.9';

const BASE_CACHE_FILES = [
    'https://next.ink/wp-content/uploads/2023/12/nextFav192.png',
'',
'https://next.ink/wp-content/uploads/2023/12/nextFav.png',
'',
'https://next.ink/wp-content/uploads/2023/12/nextFav.png',
...
const OFFLINE_PAGE = 'https://next.ink/';
const NOT_FOUND_PAGE = 'https://next.ink/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://next.ink//wp-admin/');
//    },
];
