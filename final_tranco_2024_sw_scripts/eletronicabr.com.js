"use strict";
const DEBUG = false;
const BASE_URL = "https://eletronicabr.com/";
const CACHED_ASSETS = ["https://eletronicabr.com/offline/"];
const CACHE_NAME = 'invision-community-2fdc755a181724630391';
const OFFLINE_URL = "https://eletronicabr.com/offline/";
const NOTIFICATION_ICON = "https://eletronicabr.com/uploads/monthly_2023_04/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Você tem uma nova notificação";
const DEFAULT_NOTIFICATION_BODY = "Você precisará visitar o site para lê-lo. Toque aqui para fazer login.";
/**
 * Invision Community
