"use strict";
const DEBUG = false;
const BASE_URL = "https://www.babyplan.ru/";
const CACHED_ASSETS = ["https://www.babyplan.ru/offline/"];
const CACHE_NAME = 'invision-community-5e2a07f83d1717010625';
const OFFLINE_URL = "https://www.babyplan.ru/offline/";
const NOTIFICATION_ICON = "https://www.babyplan.ru/uploads/monthly_2024_05/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "У вас есть новое уведомление";
const DEFAULT_NOTIFICATION_BODY = "Чтобы прочитать его, вам нужно зайти сайт. Нажмите здесь, чтобы войти.";
/**
 * Invision Community
