"use strict";
const DEBUG = false;
const BASE_URL = "https://camcaps.net/";
const CACHED_ASSETS = ["https://camcaps.net/offline/"];
const CACHE_NAME = 'invision-community-ed1a9b78101731148354';
const OFFLINE_URL = "https://camcaps.net/offline/";
