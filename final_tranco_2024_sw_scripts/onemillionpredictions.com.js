const CACHE_VERSION = '1.7.44.18';

const BASE_CACHE_FILES = [
    'https://onemillionpredictions.com/wp-content/uploads/2020/11/icon-192x192px.png',
'https://onemillionpredictions.com/wp-content/uploads/2020/11/icon-512x512px.png',

];

const OFFLINE_CACHE_FILES = [
     'https://onemillionpredictions.com/',
];
...
const OFFLINE_PAGE = 'https://onemillionpredictions.com/';
const NOT_FOUND_PAGE = 'https://onemillionpredictions.com/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://onemillionpredictions.com//wp-admin/');
//    },
];
const neverCacheUrls = [/\/wp-admin/,/\/wp-login/,/preview=true/,/\/cart/,/ajax/,/login/,/https:\/\/onemillionpredictions.com\/today-football-predictions\/results\//,/https:\/\/onemillionpredictions.com\/monday-football-predictions\/results\//,/https:\/\/onemillionpredictions.com\/tuesday-football-predictions\/results\//,/https:\/\/onemillionpredictions.com\/wednesday-football-predictions\/results\//,/https:\/\/onemillionpredictions.com\/thursday-football-predictions\/results\//,/https:\/\/onemillionpredictions.com\/friday-football-predictions\/results\//,/https:\/\/onemillionpredictions.com\/saturday-football-predictions\/results\//,/https:\/\/onemillionpredictions.com\/sunday-football-predictions\/results\//];
