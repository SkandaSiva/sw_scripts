...
const cacheName = 'http://www.chaymarket.com-superpwa-3.8.2';
const startPage = 'https://www.chaymarket.com/';
const offlinePage = 'https://www.chaymarket.com/offline/';

const filesToCache = [startPage, offlinePage];
const neverCacheUrls = [/\/wp-admin/,/\/wp-login/,/preview=true/,/https:\/\/www.chaymarket.com\/user\/checkout/,/https:\/\/www.chaymarket.com\/user\/cart/,/https:\/\/www.chaymarket.com\/user\/my-account/];
