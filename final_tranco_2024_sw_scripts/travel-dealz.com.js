...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/travel-dealz.com\/app\/plugins\/pwa\/wp-includes\/js\/workbox-v7.3.0\/"} );
...
(() => {
	wp.serviceWorker.precaching.precache([{"url":"https:\/\/travel-dealz.com\/app\/themes\/tatami-travel-dealz\/pwa\/wp_error_template_offline.html","revision":1731582542},{"url":"https:\/\/travel-dealz.com\/app\/themes\/tatami-travel-dealz\/pwa\/wp_error_template_500.html","revision":1731582542}]);
...
/* Source tatami-serviceworker <https://travel-dealz.com/app/themes/tatami-travel-dealz/src/js/serviceworker.js>: */
...
self.addEventListener('push', function (event) {
	...
	const title = data.title || "Travel-Dealz";

	let options = {
		body: data.body,
		icon: '/app/themes/tatami-travel-dealz/images/Icon.png',
		badge: '/app/themes/tatami-travel-dealz/images/Icon.png',
		data: {},
	};

	if (data.actions[0].action) {
		options.data.url = data.actions[0].action;
	}
		...
		return fetch(event.request)
					...
					return caches
						.match(
							wp.serviceWorker.precaching.getCacheKeyForURL(
								"https:\/\/travel-dealz.com\/app\/themes\/tatami-travel-dealz\/pwa\/wp_error_template_500.html"
							)
						)
			...
			.catch(() => {
				...
				return caches
					.match(
						wp.serviceWorker.precaching.getCacheKeyForURL(
							"https:\/\/travel-dealz.com\/app\/themes\/tatami-travel-dealz\/pwa\/wp_error_template_offline.html"
						)
					)
...
(() => {
	...
	const errorMessages = {"clientOffline":"It seems you are offline. Please check your internet connection and try again.","serverOffline":"The server appears to be down, or your connection isn't working as expected. Please try again later.","error":"Something prevented the page from being rendered. Please try again.","submissionFailure":"Your submission failed. Please go back and try again."};
	const navigationRouteEntry = {"url":null,"revision":"0.8.2;tatami-travel-dealz=4.18.0;options=303f91d1932c396be8dbcbad6cffbf74;nav=d1cea55c05c1aa0476e3a51e2e08323d;deps=a19099666e3cce0136d9fb1e89a8186b"};
