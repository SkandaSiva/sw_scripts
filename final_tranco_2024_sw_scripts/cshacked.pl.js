"use strict";
const DEBUG = false;
const BASE_URL = "https://www.cshacked.pl/";
const CACHED_ASSETS = ["https://www.cshacked.pl/offline/"];
const CACHE_NAME = 'invision-community-9829c014381731149090';
const OFFLINE_URL = "https://www.cshacked.pl/offline/";
const NOTIFICATION_ICON = "//css.s3.waw.io.cloud.ovh.net/css/monthly_2024_01/android-chrome-192x192.png";
