...
;(function (self, localforage) {
  ...
  var wpOfflineContent = self.wpOfflineContent = {
    ...
    version: "150764d15347fceed27fbc71529df72b",

    storage: localforage.createInstance({ name: PRIVATE_NAME }),

    resources: [],

    excludedPaths: ["https:\/\/www.fortunefrenzy.co.uk\/wp-admin\/","https:\/\/www.fortunefrenzy.co.uk\/wp-content","https:\/\/www.fortunefrenzy.co.uk\/wp-includes\/"],
