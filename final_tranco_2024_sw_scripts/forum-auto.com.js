"use strict";
const DEBUG = false;
const BASE_URL = "https://forum-auto.caradisiac.com/";
const CACHED_ASSETS = ["https://forum-auto.caradisiac.com/offline/"];
const CACHE_NAME = 'invision-community-d815db93211729071212';
const OFFLINE_URL = "https://forum-auto.caradisiac.com/offline/";
const NOTIFICATION_ICON = "//content-eu.invisioncic.com/m304542/monthly_2023_04/android-chrome-192x192.png";
const DEFAULT_NOTIFICATION_TITLE = "Vous avez une nouvelle notification";
const DEFAULT_NOTIFICATION_BODY = "Vous devez aller sur le site pour le lire. Cliquez ici pour vous connecter.";
/**
 * Invision Community
