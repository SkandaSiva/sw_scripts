...
workbox.setConfig( {"debug":false,"modulePathPrefix":"https:\/\/lbbusinessjournal.com\/wp-content\/plugins\/pwa\/wp-includes\/js\/workbox-v7.3.0\/"} );
...
(() => {
	wp.serviceWorker.precaching.precache([{"url":"https:\/\/lbbusinessjournal.com\/?wp_error_template=offline","revision":"0.8.2;newspack-theme=1.76.0-alpha.1;newspack-lbbj=1.0.12;options=aaf9ae43fb660dc4d0f2db817c8b636c;nav=dbedcba3be035e39e392766511d855ad;deps=ec32c1dcc25b94d2ebc000e1d2c1d77b;73b931bc3fcf22628fbfd3a7c461a267"},{"url":"https:\/\/lbbusinessjournal.com\/?wp_error_template=500","revision":"0.8.2;newspack-theme=1.76.0-alpha.1;newspack-lbbj=1.0.12;options=aaf9ae43fb660dc4d0f2db817c8b636c;nav=dbedcba3be035e39e392766511d855ad;deps=ec32c1dcc25b94d2ebc000e1d2c1d77b;6906654b4aa54a67bcdefdfcdd086a7f"}]);
		...
		return fetch(event.request)
					...
					return caches
						.match(
							wp.serviceWorker.precaching.getCacheKeyForURL(
								"https:\/\/lbbusinessjournal.com\/?wp_error_template=500"
							)
						)
			...
			.catch(() => {
				...
				return caches
					.match(
						wp.serviceWorker.precaching.getCacheKeyForURL(
							"https:\/\/lbbusinessjournal.com\/?wp_error_template=offline"
						)
					)
...
(() => {
	...
	const errorMessages = {"clientOffline":"It seems you are offline. Please check your internet connection and try again.","serverOffline":"There has been a problem connecting with the server. Please check your internet connection or try again later.","error":"Something prevented the page from being rendered. Please try again.","submissionFailure":"Your submission failed. Please go back and try again."};
	const navigationRouteEntry = {"url":null,"revision":"0.8.2;newspack-theme=1.76.0-alpha.1;newspack-lbbj=1.0.12;options=aaf9ae43fb660dc4d0f2db817c8b636c;nav=dbedcba3be035e39e392766511d855ad;deps=ec32c1dcc25b94d2ebc000e1d2c1d77b"};
