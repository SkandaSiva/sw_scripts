...
self.addEventListener('activate', function (event) {
    var cacheWhitelist = ['data-api-cache-v1731189713941', 'data-api-cache-v1731189713941',
        'jscss-cache-v1731189713941', 'template-cache-v1731189713941'];
...
workbox.precaching.precacheAndRoute(
  [{"url":"https://www.yslbeauty.com/on/demandware.static/Sites-NGYSL-ILM-Site/-/en_IN/v1731189713941/dist/css/commons.css","revision":"v1731189713941"},{"url":"https://www.yslbeauty.com/on/demandware.static/-/Sites-NGYSL-ILM-Library/default/dwa3bca8a8/images/demo/offline.png","revision":"v1731189713941"}]
);
...
self.addEventListener('install', function(event) {
  event.waitUntil(
    caches.open('prepopulated-cache-v1731189713941').then(function(cache) {
      return cache.addAll(["/","https://www.yslbeauty.com/int/transversal/transversal-offline.html"]);
    })
  );
});
      ...
      fetch(event.request).catch(function(error) {
        ...
        return caches.match(event.request).then(function (response) {
          ...
          if (response) {
            ...
            return caches.match('https://www.yslbeauty.com/int/transversal/transversal-offline.html');
          }
        });
      })
    );
...
workbox.routing.registerRoute(
  ...
  new workbox.strategies.NetworkFirst({
    cacheName: 'prepopulated-cache-v1731189713941',
    plugins: [
...
workbox.routing.registerRoute(
  'https://www.yslbeauty.com/int/transversal/transversal-offline.html',
  new workbox.strategies.NetworkFirst({
    cacheName: 'prepopulated-cache-v1731189713941',
    plugins: [
      new workbox.expiration.ExpirationPlugin({
...
workbox.routing.registerRoute(
  ...
  new workbox.strategies.CacheFirst({
    cacheName: 'jscss-cache-v1731189713941',
    plugins: [
