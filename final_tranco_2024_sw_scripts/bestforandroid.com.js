const CACHE_VERSION = '1.8.1.13';

const BASE_CACHE_FILES = [
    'https://bestforandroid.com/wp-content/uploads/2019/10/192-pw.png',
'',
'https://bestforandroid.com/wp-content/uploads/2022/03/faviconlogo.jpg',
'',
'https://bestforandroid.com/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
'https://bestforandroid.com/android-dev-learning-resources/',
'https://bestforandroid.com/android-education-apps/',
'https://bestforandroid.com/tools-to-help-you-grow-your-small-business/',
'https://bestforandroid.com/best-android-vpns/',
'https://bestforandroid.com/fitness-workout-tracking-apps/',

];

const OFFLINE_CACHE_FILES = [
     'https://bestforandroid.com/',
];
...
const OFFLINE_PAGE = 'https://bestforandroid.com/';
const NOT_FOUND_PAGE = 'https://bestforandroid.com/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://bestforandroid.com//wp-admin/');
//    },
];
