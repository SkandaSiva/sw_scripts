"use strict";
const DEBUG = false;
const BASE_URL = "https://www.sectorvip.cl/";
const CACHED_ASSETS = ["https://www.sectorvip.cl/offline/"];
const CACHE_NAME = 'invision-community-989de3db791729506687';
const OFFLINE_URL = "https://www.sectorvip.cl/offline/";
const NOTIFICATION_ICON = null;
const DEFAULT_NOTIFICATION_TITLE = "Tienes una nueva notificación";
const DEFAULT_NOTIFICATION_BODY = "Viste lo que acaban de subir? Se el primero y comenta la publicación.";
/**
 * Invision Community
